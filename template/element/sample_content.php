...
<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam dignissim convallis est. Quisque aliquam. Donec faucibus. Nunc iaculis suscipit dui. Nam sit amet sem. Aliquam libero nisi, imperdiet at, tincidunt nec, gravida vehicula, nisl. Praesent mattis, massa quis luctus fermentum, turpis mi volutpat justo, eu volutpat enim diam eget metus.</p>
	...
	<p><input type="text" id="text_field"></p>
	...
	<span class="checkbox-wpg">
		<p>
		<span class="checkbox-continer">
		    <input type="checkbox" name="checkboxes-wpg">
		    <i class="state"></i>
   			<label for="checkboxes-wpg">Przykładowy tekst checkboxa</label>
		</label>
		</span>
		</p>
		<p>
			<span class="checkbox-continer">
			    <input type="radio" name="radioTest1">
			    <i class="state"></i>
   				<label for="radioTest1">Przykładowy tekst checkboxa</label>
	...
	<p><input type="file" class="file" name="file"></p>
